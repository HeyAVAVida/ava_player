...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "${BUILT_PRODUCTS_DIR}/auto_orientation/auto_orientation.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/flutter_screen_wake/flutter_screen_wake.framework"
